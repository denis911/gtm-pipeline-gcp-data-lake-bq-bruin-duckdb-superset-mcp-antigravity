...
- Run python files as ```uv run python file_name.py```
- Avoid system python or notify user when you need to install packages. User controls and installs packages. Then changes and packages should be documented in the README.md file.

---

## 7. Documentation
- Always update the README.md file when changes are made.
- Always update the AGENTS.md file when changes are made.
- Divide the documentation into logical sections.
- Use clear and concise language.
- Use code blocks for code examples.
- Use tables for data examples.
- Use diagrams for architectural examples.
- Use mermaid for diagrams.

---

## 8. Testing, coding workflow, github and changes in code
- User commits changes to Github.
- Always test your code after making changes.
- Break coding workflow into smallest changes possible, notify user when changes are made and ask to double-check and test manually, then proceed with   making changes to the documentation so it could be committed and pushed to Github.
...
- Notify user when API keys are needed and where to store them in a secure way.
